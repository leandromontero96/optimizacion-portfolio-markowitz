...
**Leandro Montero**
- 💼 Especialista en Quantitative Finance
- 🎯 Portfolio Optimization & Risk Management
- 📧 [Email](mailto:leandro@ejemplo.com)
- 💼 [LinkedIn](https://linkedin.com/in/leandromontero)
- 🐙 [GitHub](https://github.com/leandromontero96)
...
- Harry Markowitz por la teoría fundamental
- William Sharpe por el ratio de Sharpe
- Comunidad de quantitative finance

---

**⭐ Si este proyecto te fue útil, considera darle una estrella!**

**💡 Nota**: Este proyecto utiliza datos sintéticos para demostración. Para uso en producción, integrar con APIs de mercado real (Yahoo Finance, Alpha Vantage, etc.).
